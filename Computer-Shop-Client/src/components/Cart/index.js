...
function Cart() {
    ...
    // rendering ...
    return (
        <div className="Cart-Detail-View container m-t-20" style={{ minHeight: '80vh' }}>
            <Row gutter={[16, 32]}>
                ...
                <Col span={24} className="d-flex page-position">
                    ...
                    <span className="cart-name p-8 font-weight-500 bg-white">Giỏ hàng của bạn</span>
                </Col>
                ...
                {cartItems.length > 0 ? (
                    <>
                        ...
                        <Col span={24} className="d-flex justify-content-between">
                            <h2>
                                Giỏ hàng của bạn
                                <b>{` ${cartItems.reduce((a, b) => a + parseInt(b.qty), 0)} `}</b>
                                sản phẩm
                            </h2>
                            <Popconfirm
